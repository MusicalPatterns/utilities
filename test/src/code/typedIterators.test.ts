...
describe('typed iterators', () => {
    describe('slice', () => {
        ...
        it('throws when you exceed the bounds, because i lost a day of my life trying to figure out what was wrong with my continuous mode hafuhafu logic and all that was wrong was that my zero and positive integers array constant only went up to 256 and was silently not giving me any more integers', () => {
            const array: Scalar[] = [ 1, 2, 3, 4, 5, 6 ].map(as.Scalar)
