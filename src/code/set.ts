...
const arraySet: <ElementType>(array: ElementType[], index: Index, value: ElementType) => ElementType[] =
    <ElementType>(array: ElementType[], index: Index, value: ElementType): ElementType[] => {
