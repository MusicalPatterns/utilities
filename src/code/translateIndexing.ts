...
const translateFromOneIndexedToZeroIndexed: <ElementType, ArrayType extends ArrayedType<ElementType> = ElementType[]>(
...
const translateFromZeroIndexedToOneIndexed: <ElementType, ArrayType extends ArrayedType<ElementType> = ElementType[]>(
    index: Ordinal<ArrayType>,
) => Ordinal<ArrayType> =
    <ElementType, ArrayType extends ArrayedType<ElementType> = ElementType[]>(
        index: Ordinal<ArrayType>,
