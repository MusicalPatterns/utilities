...
const DOUBLE: Multiple<any> = as.Multiple(2)
const TRIPLE: Multiple<any> = as.Multiple(3)
const QUADRUPLE: Multiple<any> = as.Multiple(4)
const PENTUPLE: Multiple<any> = as.Multiple(5)
const SEXTUPLE: Multiple<any> = as.Multiple(6)
const HEPTUPLE: Multiple<any> = as.Multiple(7)
const OCTUPLE: Multiple<any> = as.Multiple(8)
const NONTUPLE: Multiple<any> = as.Multiple(9)
