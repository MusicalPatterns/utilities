...
const Hz: <U extends Abstract, T extends Hz<U>>(hz: T) => U & number =
    <U extends Abstract, T extends Hz<U>>(hz: T): U & number => hz as unknown as U & number
const Ms: <U extends Abstract, T extends Ms<U>>(ms: T) => U & number =
    <U extends Abstract, T extends Ms<U>>(ms: T): U & number => ms as unknown as U & number
const Radians: <U extends Abstract, T extends Radians<U>>(radians: T) => U & number =
    <U extends Abstract, T extends Radians<U>>(radians: T): U & number => radians as unknown as U & number
const Cents: <U extends Abstract, T extends Cents<U>>(cents: T) => U & number =
    <U extends Abstract, T extends Cents<U>>(cents: T): U & number => cents as unknown as U & number
const Semitones: <U extends Abstract, T extends Semitones<U>>(semitones: T) => U & number =
    <U extends Abstract, T extends Semitones<U>>(semitones: T): U & number => semitones as unknown as U & number
const Meters: <U extends Abstract, T extends Meters<U>>(meters: T) => U & number =
    <U extends Abstract, T extends Meters<U>>(meters: T): U & number => meters as unknown as U & number
const Space: <U extends Abstract, T extends Space<U>>(space: T) => U & number =
    <U extends Abstract, T extends Space<U>>(space: T): U & number => space as unknown as U & number
const Time: <U extends Abstract, T extends Time<U>>(time: T) => U & number =
    <U extends Abstract, T extends Time<U>>(time: T): U & number => time as unknown as U & number
const Frequency: <U extends Abstract, T extends Frequency<U>>(frequency: T) => U & number =
    <U extends Abstract, T extends Frequency<U>>(frequency: T): U & number => frequency as unknown as U & number
const Amplitude: <U extends Abstract, T extends Amplitude<U>>(amplitude: T) => U & number =
    <U extends Abstract, T extends Amplitude<U>>(amplitude: T): U & number => amplitude as unknown as U & number

// Operation

const Scalar: <U extends Operand, T extends Scalar<U>>(scalar: T) => U & number =
    <U extends Operand, T extends Scalar<U>>(scalar: T): U & number => scalar as unknown as U & number
const Translation: <U extends Operand, T extends Translation<U>>(translation: T) => U & number =
    <U extends Operand, T extends Translation<U>>(translation: T): U & number => translation as unknown as U & number
const Rotation: <U extends Operand, T extends Rotation<U>>(rotation: T) => U & number =
    <U extends Operand, T extends Rotation<U>>(rotation: T): U & number => rotation as unknown as U & number

const Base: <U extends Operand, T extends Base<U>>(base: T) => U & number =
    <U extends Operand, T extends Base<U>>(base: T): U & number => base as unknown as U & number
const Power: <U extends Operand, T extends Power<U>>(power: T) => U & number =
    <U extends Operand, T extends Power<U>>(power: T): U & number => power as unknown as U & number

const Modulus: <U extends Operand, T extends Modulus<U>>(modulus: T) => U & number =
    <U extends Operand, T extends Modulus<U>>(modulus: T): U & number => modulus as unknown as U & number

// Special Units & Operation

const Integer: <T extends Integer>(integer: T) => number =
    <T extends Integer>(integer: T): number => integer as unknown as number
...
const Numerator: (numerator: Numerator) => number =
    (numerator: Numerator): number => numerator as unknown as number
const Denominator: (denominator: Denominator) => number =
    (denominator: Denominator): number => denominator as unknown as number
...
const Block: (block: Block) => number[] =
    (block: Block): number[] => block as unknown as number[]
